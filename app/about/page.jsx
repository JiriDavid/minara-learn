        ...
        <section className="flex flex-col md:flex-row gap-12 items-center mb-20">
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-200 mb-6">
              ...
              that often expose students to risk and deepen financial
              inequality.
            </p>
            ...
            <Card className="overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-6">
                  ...
                  quality education, ensuring no student is left behind because
                  of where they live or what they earn.
                </p>
                <ul className="space-y-3">
                  {[
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[500px] overflow-hidden rounded-xl">
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white">
                ...
                <p>
                  Minara Learn started as a response to a painful truth —
                  students in Zimbabwe were being forced into unsafe, expensive
                  night lessons. We’re stepping up with a better way.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-300">
                <p>
                  ...
                  burden to stop exploitative extra lessons that often took
                  place late at night and left many students vulnerable.
                </p>
                <p>
                  These night sessions not only exposed students to physical
                  risks, but also deepened inequality— as only wealthier
                  families could afford them. Many teachers began holding back
                  during regular school hours to force learners into paying
                  more.
                </p>
                <p>
                  Minara Learn was born to change this — to offer students safe,
                  affordable, and flexible access to quality learning anytime,
                  anywhere. Though we’re just beginning, we believe this idea
                  can transform education across Zimbabwe, Africa, and beyond.
                </p>
              </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              passionate team of educators, technologists, and community
              builders committed to transforming education across Africa.
            </p>
          </div>
            ...
            <Card className="overflow-hidden border-0 shadow-md group">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-slate-600 dark:text-slate-200">
                  David is a Computer Science student and innovator with a
                  burden to make quality education safe and accessible for every
                  learner — regardless of their background, income, or location.
                  He currently leads Minara Learn solo while laying a foundation
                  for a future team that shares this vision.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden border-0 shadow-md group">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-slate-600 dark:text-slate-200">
                  ...
                  curriculum design, development, marketing, and operations —
                  all united by a shared belief that education should be a
                  right, not a luxury.
                </p>
              </CardContent>
            </Card>
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-300 dark:text-slate-400 mb-6">
                    At Minara Learn, we are at the beginning of a bold
                    journey—one that's driven by a deep desire to make learning
                    more accessible, practical, and human-centered. While we're
                    small now, our culture is fueled by curiosity, grit, and a
